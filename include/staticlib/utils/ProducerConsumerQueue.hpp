...
#ifndef PRODUCER_CONSUMER_QUEUE_HPP
#define PRODUCER_CONSUMER_QUEUE_HPP
...
//        }
    ...
    /**
     * Remove the item from the front of the queue (queue must not be empty).
     */
    void popFront() {
        auto const currentRead = readIndex_.load(std::memory_order_relaxed);
...
#endif /* PRODUCER_CONSUMER_QUEUE_HPP */
